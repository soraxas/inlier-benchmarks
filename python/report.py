...
def main(summary_path: str, output_dir: str) -> None:
    ...
    (output / "index.html").write_text(
        ...
        "td,th{border:1px solid #666;padding:.4rem;text-align:right}td:first-child,td:nth-child(2),td:nth-child(3),td:nth-child(4),td:nth-child(5),td:nth-child(6){text-align:left}"
